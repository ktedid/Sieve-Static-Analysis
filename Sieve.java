// Katee Coleman - CS 1632 Ex.6
// Reworked Sieve code
// Fixed code using bug finder "FindBugs"
...
public class Sieve {
    ...
    public static int calculateMax(String[] args) {
    	...
    	if (args.length > 0) {
    		...
    		throw new IllegalArgumentException("You must enter a valid integer as an argument.");
    	    } else {
    	    }
    	} else {
    	    // User forgot to enter an argument!
    	    throw new IllegalArgumentException("You must enter one argument.");
    	}
    	return toReturn;
    }
